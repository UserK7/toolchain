...
enum opt_code
{
  ...
  OPT_Wmissing_delay_slot = 294,             /* -Wmissing-delay-slot */
  ...
  OPT_Wpossible_load_use = 337,              /* -Wpossible-load-use */
  ...
  OPT_fdafile_relative = 576,                /* -fdafile-relative */
  ...
  OPT_flinker_output_ = 770,                 /* -flinker-output= */
  ...
  OPT_frlxcov = 911,                         /* -frlxcov */
  OPT_frounding_math = 912,                  /* -frounding-math */
  OPT_frtti = 913,                           /* -frtti */
  ...
  OPT_fstack_usage_mangled = 981,            /* -fstack-usage-mangled */
  OPT_fstats = 982,                          /* -fstats */
  OPT_fstdarg_opt = 983,                     /* -fstdarg-opt */
  OPT_fstore_check = 984,                    /* -fstore-check */
  ...
  OPT_fsuppress_outer_loop_unroll = 991,     /* -fsuppress-outer-loop-unroll */
  ...
  OPT_ftls_model_ = 1005,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1006,              /* -ftoplevel-reorder */
  OPT_ftracer = 1007,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1008,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1009,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1010,                 /* -ftrapping-math */
  OPT_ftrapv = 1011,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1012,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1013,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1014,                      /* -ftree-ccp */
  OPT_ftree_ch = 1015,                       /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 1016,    /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1017,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1018,                /* -ftree-copy-prop */
  OPT_ftree_copyrename = 1019,               /* -ftree-copyrename */
  OPT_ftree_cselim = 1020,                   /* -ftree-cselim */
  OPT_ftree_dce = 1021,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1022,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1023,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1024,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1025,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1026, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1027,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1028,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1029,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1030,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1031,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1032, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1033,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1034,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1035,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1036,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1037,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1038,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1039,                      /* -ftree-pre */
  OPT_ftree_pta = 1040,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1041,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1042, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1043,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1044,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1045,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1046,                     /* -ftree-slsr */
  OPT_ftree_sra = 1047,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1048, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1049, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1050,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1051,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1052,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1053, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1054,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1055, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1056,                      /* -ftree-vrp */
  OPT_ftword = 1057,                         /* -ftword */
  OPT_ftword_stack = 1058,                   /* -ftword-stack */
  OPT_funderscoring = 1059,                  /* -funderscoring */
  OPT_funit_at_a_time = 1060,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1061,              /* -funroll-all-loops */
  OPT_funroll_loops = 1062,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1063,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1064,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1065,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1066,                 /* -funsigned-char */
  OPT_funswitch_loops = 1067,                /* -funswitch-loops */
  OPT_funwind_tables = 1068,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1069,           /* -fuse-atomic-builtins */
  OPT_fuse_balx = 1070,                      /* -fuse-balx */
  OPT_fuse_boehm_gc = 1071,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1072,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1073,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1074,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1075,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1076,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1077,             /* -fuse-linker-plugin */
  OPT_fuse_tls = 1078,                       /* -fuse-tls */
  OPT_fuse_uls = 1079,                       /* -fuse-uls */
  ...
  OPT_profile = 1202,                        /* -profile */
  OPT_pthread = 1203,                        /* -pthread */
  OPT_quiet = 1204,                          /* -quiet */
  OPT_r = 1205,                              /* -r */
  OPT_rdynamic = 1206,                       /* -rdynamic */
  OPT_remap = 1207,                          /* -remap */
  OPT_s = 1208,                              /* -s */
  OPT_s_bc_abi = 1209,                       /* -s-bc-abi */
  OPT_save_temps = 1210,                     /* -save-temps */
  OPT_save_temps_ = 1211,                    /* -save-temps= */
  OPT_shared = 1212,                         /* -shared */
  OPT_shared_libgcc = 1213,                  /* -shared-libgcc */
  /* OPT_specs = 1214, */                    /* -specs */
  OPT_specs_ = 1215,                         /* -specs= */
  OPT_static = 1216,                         /* -static */
  OPT_static_libasan = 1217,                 /* -static-libasan */
  OPT_static_libgcc = 1218,                  /* -static-libgcc */
  OPT_static_libgcj = 1219,                  /* -static-libgcj */
  OPT_static_libgfortran = 1220,             /* -static-libgfortran */
  OPT_static_libgo = 1221,                   /* -static-libgo */
  OPT_static_liblsan = 1222,                 /* -static-liblsan */
  OPT_static_libmpx = 1223,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1224,          /* -static-libmpxwrappers */
  ...
  /* OPT_std_c__17 = 1232, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1233, */                /* -std=c++1y */
  OPT_std_c__1z = 1234,                      /* -std=c++1z */
  OPT_std_c__98 = 1235,                      /* -std=c++98 */
  OPT_std_c11 = 1236,                        /* -std=c11 */
  /* OPT_std_c1x = 1237, */                  /* -std=c1x */
  /* OPT_std_c89 = 1238, */                  /* -std=c89 */
  OPT_std_c90 = 1239,                        /* -std=c90 */
  OPT_std_c99 = 1240,                        /* -std=c99 */
  /* OPT_std_c9x = 1241, */                  /* -std=c9x */
  OPT_std_f2003 = 1242,                      /* -std=f2003 */
  OPT_std_f2008 = 1243,                      /* -std=f2008 */
  OPT_std_f2008ts = 1244,                    /* -std=f2008ts */
  OPT_std_f95 = 1245,                        /* -std=f95 */
  OPT_std_gnu = 1246,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1247, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1248, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1249,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1250,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1251, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1252, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1253,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1254,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1255,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1256, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1257, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1258,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1259,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1260, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1261, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1262,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1263, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1264, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1265, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1266,                     /* -std=legacy */
  OPT_symbolic = 1267,                       /* -symbolic */
  OPT_t = 1268,                              /* -t */
  OPT_time = 1269,                           /* -time */
  OPT_time_ = 1270,                          /* -time= */
  OPT_traditional = 1271,                    /* -traditional */
  OPT_traditional_cpp = 1272,                /* -traditional-cpp */
  OPT_trigraphs = 1273,                      /* -trigraphs */
  OPT_u = 1274,                              /* -u */
  OPT_undef = 1275,                          /* -undef */
  OPT_v = 1276,                              /* -v */
  OPT_version = 1277,                        /* -version */
  OPT_w = 1278,                              /* -w */
  OPT_wrapper = 1279,                        /* -wrapper */
  OPT_x = 1280,                              /* -x */
  OPT_z = 1281,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
