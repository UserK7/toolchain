...
enum opt_code
{
  ...
  OPT_mapcs_float = 1157,                    /* -mapcs-float */
  OPT_mapcs_frame = 1158,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1159,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1160,              /* -mapcs-stack-check */
  OPT_march_ = 1161,                         /* -march= */
  OPT_marm = 1162,                           /* -marm */
  OPT_masm_syntax_unified = 1163,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1164,                    /* -mbig-endian */
  OPT_mbionic = 1165,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1166,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1167,     /* -mcaller-super-interworking */
  OPT_mcmse = 1168,                          /* -mcmse */
  OPT_mcpu_ = 1169,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1170,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1171,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1172,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1173,                  /* -mfp16-format= */
  OPT_mfpu_ = 1174,                          /* -mfpu= */
  OPT_mglibc = 1175,                         /* -mglibc */
  /* OPT_mhard_float = 1176, */              /* -mhard-float */
  OPT_mlittle_endian = 1177,                 /* -mlittle-endian */
  OPT_mlong_calls = 1178,                    /* -mlong-calls */
  OPT_mmusl = 1179,                          /* -mmusl */
  OPT_mneon_for_64bits = 1180,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1181,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1182,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1183,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1184,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1185,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1186,               /* -mprint-tune-info */
  OPT_mpure_code = 1187,                     /* -mpure-code */
  OPT_mrestrict_it = 1188,                   /* -mrestrict-it */
  OPT_msched_prolog = 1189,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1190,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1191,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1192, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1193,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1194,                         /* -mthumb */
  OPT_mthumb_interwork = 1195,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1196,                  /* -mtls-dialect= */
  OPT_mtp_ = 1197,                           /* -mtp= */
  OPT_mtpcs_frame = 1198,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1199,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1200,                         /* -mtune= */
  OPT_muclibc = 1201,                        /* -muclibc */
  OPT_munaligned_access = 1202,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1203,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1204,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1205,              /* -mword-relocations */
  OPT_n = 1206,                              /* -n */
  ...
  OPT_time = 1302,                           /* -time */
  OPT_time_ = 1303,                          /* -time= */
  OPT_tno_android_cc = 1304,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1305,                 /* -tno-android-ld */
  OPT_traditional = 1306,                    /* -traditional */
  OPT_traditional_cpp = 1307,                /* -traditional-cpp */
  OPT_trigraphs = 1308,                      /* -trigraphs */
  OPT_u = 1309,                              /* -u */
  OPT_undef = 1310,                          /* -undef */
  OPT_v = 1311,                              /* -v */
  OPT_version = 1312,                        /* -version */
  OPT_w = 1313,                              /* -w */
  OPT_wrapper = 1314,                        /* -wrapper */
  OPT_x = 1315,                              /* -x */
  OPT_z = 1316,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
