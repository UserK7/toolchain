...
#define BE8_LINK_SPEC \
  " %{!mlittle-endian:%{march=armv7-a|mcpu=cortex-a5    \
   ...
   |march=armv8.1-a					\
   |march=armv8.1-a+crc					\
   |march=armv8-m.base|mcpu=cortex-m23|mcpu=kinmen-m-base|mcpu=taroko-m-base	\
   |march=armv8-m.main|mcpu=kinmen-m-main|mcpu=kinmen-m|mcpu=taroko-m-main|mcpu=taroko-m	\
