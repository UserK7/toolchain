...
#define HAVE_madsi_mac (TARGET_MAC32 && !TARGET_MIPS16)
#define HAVE_madsidi3_32bit_mac (TARGET_MAC32 && !TARGET_MIPS16)
#define HAVE_umadsidi3_32bit_mac (TARGET_MAC32 && !TARGET_MIPS16)
#define HAVE_madhl_mac (TARGET_MAC16 && !TARGET_MIPS16)
#define HAVE_msubsi_mac (TARGET_MAC32 && !TARGET_MIPS16)
#define HAVE_msubsidi3_32bit_mac (TARGET_MAC32 && !TARGET_MIPS16)
#define HAVE_umsubsidi3_32bit_mac (TARGET_MAC32 && !TARGET_MIPS16)
#define HAVE_msbhl_mac (TARGET_MAC16 && !TARGET_MIPS16)
#define HAVE_mszhl_mac (TARGET_MAC16 && !TARGET_MIPS16 && GET_CODE(operands[3]) == GET_CODE(operands[4]))
#define HAVE_mazhl_mac (TARGET_MAC16 && !TARGET_MIPS16 && GET_CODE(operands[3]) == GET_CODE(operands[4]))
#define HAVE_abssi2 (TARGET_RLX_RAD && !TARGET_MIPS16)
#define HAVE_sminsi3_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_smaxsi3_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_addrsi3_saturation_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_addrsi3_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_subrsi3_saturation_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_subrsi3_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_multasi3_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_multadi3_5x8x ((TARGET_RADIAX && !TARGET_MIPS16) && (TARGET_64BIT))
#define HAVE_multasi3_highpart_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_multausi3_highpart_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_multasidi3_32bit_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_multausidi3_32bit_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_divamodsi4_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_divaumodsi4_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_maddasi_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_maddasidi3_32bit_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_maddausidi3_32bit_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_msubasi_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_msubasidi3_32bit_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
#define HAVE_msubausidi3_32bit_5x8x (TARGET_RADIAX && !TARGET_MIPS16)
...
#define HAVE_doloop_end_pattern ((TARGET_RLX_RAD && !TARGET_MIPS16) \
    && (TARGET_ZERO_OVERHEAD || TARGET_UNSAFE_ZERO_OVERHEAD) \
    && flag_ivopts)
#define HAVE_addr2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_subr2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_absr2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_min2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_max2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_multa2_low (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_multa2_high (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_multa2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_mulna2_low (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_mulna2_high (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_mulna2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_madda2_low (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_madda2_high (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_madda2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_msuba2_low (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_msuba2_high (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_msuba2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_sllv2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_srlv2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_srav2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_sltr2 (TARGET_SIMD && !TARGET_MIPS16)
#define HAVE_trap 1
...
#define HAVE_mulhisi3 (TARGET_MAC16 && !TARGET_MIPS16)
...
extern rtx        gen_multa2_low                      (rtx, rtx, rtx);
extern rtx        gen_multa2_high                     (rtx, rtx, rtx);
extern rtx        gen_multa2                          (rtx, rtx, rtx);
extern rtx        gen_mulna2_low                      (rtx, rtx, rtx);
extern rtx        gen_mulna2_high                     (rtx, rtx, rtx);
extern rtx        gen_mulna2                          (rtx, rtx, rtx);
extern rtx        gen_madda2_low                      (rtx, rtx, rtx, rtx);
extern rtx        gen_madda2_high                     (rtx, rtx, rtx, rtx);
extern rtx        gen_madda2                          (rtx, rtx, rtx, rtx);
extern rtx        gen_msuba2_low                      (rtx, rtx, rtx, rtx);
extern rtx        gen_msuba2_high                     (rtx, rtx, rtx, rtx);
extern rtx        gen_msuba2                          (rtx, rtx, rtx, rtx);
...
static inline rtx gen_tls_get_tp_mips16r_si           (rtx, rtx);
static inline rtx
gen_tls_get_tp_mips16r_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_tls_get_tp_mips16r_di           (rtx, rtx);
static inline rtx
gen_tls_get_tp_mips16r_di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
