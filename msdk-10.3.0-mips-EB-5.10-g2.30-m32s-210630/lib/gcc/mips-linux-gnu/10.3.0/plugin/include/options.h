...
enum opt_code
{
  ...
  OPT_Wmissing_delay_slot = 571,             /* -Wmissing-delay-slot */
  ...
  OPT_Wpossible_load_use = 627,              /* -Wpossible-load-use */
  ...
  OPT_fforce_conv = 1040,                    /* -fforce-conv */
  ...
  OPT_fprofile_reproducible_ = 1289,         /* -fprofile-reproducible= */
  ...
  OPT_ftword = 1496,                         /* -ftword */
  OPT_ftword_stack = 1497,                   /* -ftword-stack */
  ...
  OPT_fuse_balx = 1511,                      /* -fuse-balx */
  OPT_fuse_cxa_atexit = 1512,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1513,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1514,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1515,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1516,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1517,             /* -fuse-linker-plugin */
  OPT_fuse_tls = 1518,                       /* -fuse-tls */
  OPT_fuse_uls = 1519,                       /* -fuse-uls */
  OPT_fvar_tracking = 1520,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1521,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1522,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1523,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1524,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1525, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1526,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1527,                   /* -fverbose-asm */
  /* OPT_fversion = 1528, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1529,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1530,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1531,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1532,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1533,                   /* -fvisibility= */
  OPT_fvpt = 1534,                           /* -fvpt */
  OPT_fvtable_gc = 1535,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1536,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1537,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1538,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1539,                     /* -fvtv-debug */
  OPT_fweak = 1540,                          /* -fweak */
  OPT_fweb = 1541,                           /* -fweb */
  /* OPT_fwhole_file = 1542, */              /* -fwhole-file */
  OPT_fwhole_program = 1543,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1544,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1545,             /* -fworking-directory */
  OPT_fwpa = 1546,                           /* -fwpa */
  OPT_fwpa_ = 1547,                          /* -fwpa= */
  OPT_fwrapv = 1548,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1549,                 /* -fwrapv-pointer */
  OPT_fxref = 1550,                          /* -fxref */
  /* OPT_fzee = 1551, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1552,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1553,                     /* -fzero-link */
  OPT_g = 1554,                              /* -g */
  OPT_gant = 1555,                           /* -gant */
  OPT_gas_loc_support = 1556,                /* -gas-loc-support */
  OPT_gas_locview_support = 1557,            /* -gas-locview-support */
  OPT_gcoff = 1558,                          /* -gcoff */
  OPT_gcoff1 = 1559,                         /* -gcoff1 */
  OPT_gcoff2 = 1560,                         /* -gcoff2 */
  OPT_gcoff3 = 1561,                         /* -gcoff3 */
  OPT_gcolumn_info = 1562,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1563,                 /* -gdescribe-dies */
  OPT_gdwarf = 1564,                         /* -gdwarf */
  OPT_gdwarf_ = 1565,                        /* -gdwarf- */
  OPT_gen_decls = 1566,                      /* -gen-decls */
  OPT_ggdb = 1567,                           /* -ggdb */
  OPT_ggnu_pubnames = 1568,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1569,                   /* -gimple-stats */
  OPT_ginline_points = 1570,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1571, /* -ginternal-reset-location-views */
  OPT_gnat = 1572,                           /* -gnat */
  OPT_gnatO = 1573,                          /* -gnatO */
  OPT_gno_ = 1574,                           /* -gno- */
  OPT_gno_pubnames = 1575,                   /* -gno-pubnames */
  OPT_gpubnames = 1576,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1577,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1578,                   /* -gsplit-dwarf */
  OPT_gstabs = 1579,                         /* -gstabs */
  OPT_gstabs_ = 1580,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1581,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1582,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1583,                        /* -gtoggle */
  OPT_gvariable_location_views = 1584,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1585,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1586,                           /* -gvms */
  OPT_gxcoff = 1587,                         /* -gxcoff */
  OPT_gxcoff_ = 1588,                        /* -gxcoff+ */
  OPT_gz = 1589,                             /* -gz */
  OPT_gz_ = 1590,                            /* -gz= */
  OPT_h = 1591,                              /* -h */
  OPT_help = 1592,                           /* -help */
  OPT_idirafter = 1593,                      /* -idirafter */
  OPT_imacros = 1594,                        /* -imacros */
  OPT_imultiarch = 1595,                     /* -imultiarch */
  OPT_imultilib = 1596,                      /* -imultilib */
  OPT_include = 1597,                        /* -include */
  OPT_iplugindir_ = 1598,                    /* -iplugindir= */
  OPT_iprefix = 1599,                        /* -iprefix */
  OPT_iquote = 1600,                         /* -iquote */
  OPT_isysroot = 1601,                       /* -isysroot */
  OPT_isystem = 1602,                        /* -isystem */
  OPT_iwithprefix = 1603,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1604,              /* -iwithprefixbefore */
  OPT_k8 = 1605,                             /* -k8 */
  OPT_l = 1606,                              /* -l */
  OPT_lang_asm = 1607,                       /* -lang-asm */
  OPT_list = 1608,                           /* -list */
  OPT_mabi_ = 1609,                          /* -mabi= */
  OPT_mabicalls = 1610,                      /* -mabicalls */
  OPT_mabs_ = 1611,                          /* -mabs= */
  OPT_mandroid = 1612,                       /* -mandroid */
  OPT_march_ = 1613,                         /* -march= */
  OPT_mbionic = 1614,                        /* -mbionic */
  OPT_mbranch_cost_ = 1615,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1616,                 /* -mbranch-likely */
  OPT_mce_ = 1617,                           /* -mce= */
  OPT_mcheck_zero_division = 1618,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1619,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1620,             /* -mcompact-branches= */
  OPT_mcpu_ = 1621,                          /* -mcpu= */
  OPT_mcrc = 1622,                           /* -mcrc */
  OPT_mdebug = 1623,                         /* -mdebug */
  OPT_mdebugd = 1624,                        /* -mdebugd */
  OPT_mdivide_breaks = 1625,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1626,                  /* -mdivide-traps */
  OPT_mdmx = 1627,                           /* -mdmx */
  OPT_mdouble_float = 1628,                  /* -mdouble-float */
  OPT_mdsp = 1629,                           /* -mdsp */
  OPT_mdspr2 = 1630,                         /* -mdspr2 */
  OPT_meb = 1631,                            /* -meb */
  OPT_mel = 1632,                            /* -mel */
  OPT_membedded_data = 1633,                 /* -membedded-data */
  OPT_meva = 1634,                           /* -meva */
  OPT_mexplicit_relocs = 1635,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1636,                  /* -mextern-sdata */
  OPT_mfix_24k = 1637,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1638,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1639,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1640,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1641,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1642,                    /* -mfix-rm7000 */
  OPT_mfix_rx3081 = 1643,                    /* -mfix-rx3081 */
  OPT_mfix_sb1 = 1644,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1645,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1646,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1647,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1648,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1649,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1650,                 /* -mfp-exceptions */
  OPT_mfp32 = 1651,                          /* -mfp32 */
  OPT_mfp64 = 1652,                          /* -mfp64 */
  OPT_mfpxx = 1653,                          /* -mfpxx */
  OPT_mframe_header_opt = 1654,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1655, */              /* -mfused-madd */
  OPT_mginv = 1656,                          /* -mginv */
  OPT_mglibc = 1657,                         /* -mglibc */
  OPT_mgp32 = 1658,                          /* -mgp32 */
  OPT_mgp64 = 1659,                          /* -mgp64 */
  OPT_mgpopt = 1660,                         /* -mgpopt */
  OPT_mhard_float = 1661,                    /* -mhard-float */
  OPT_mimadd = 1662,                         /* -mimadd */
  OPT_minterlink_compressed = 1663,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1664,              /* -minterlink-mips16 */
  OPT_mips = 1665,                           /* -mips */
  OPT_mips16 = 1666,                         /* -mips16 */
  OPT_mips3d = 1667,                         /* -mips3d */
  OPT_mllsc = 1668,                          /* -mllsc */
  OPT_mload_store_pairs = 1669,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1670,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1671,                    /* -mlong-calls */
  OPT_mlong32 = 1672,                        /* -mlong32 */
  OPT_mlong64 = 1673,                        /* -mlong64 */
  OPT_mloongson_ext = 1674,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1675,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1676,                  /* -mloongson-mmi */
  OPT_mlra = 1677,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1678,                     /* -mlxc1-sxc1 */
  OPT_mmac = 1679,                           /* -mmac */
  OPT_mmac16 = 1680,                         /* -mmac16 */
  OPT_mmac32 = 1681,                         /* -mmac32 */
  OPT_mmad = 1682,                           /* -mmad */
  OPT_mmadd4 = 1683,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1684,             /* -mmcount-ra-address */
  OPT_mmcu = 1685,                           /* -mmcu */
  OPT_mmemcpy = 1686,                        /* -mmemcpy */
  OPT_mmicromips = 1687,                     /* -mmicromips */
  OPT_mmsa = 1688,                           /* -mmsa */
  OPT_mmt = 1689,                            /* -mmt */
  OPT_mmusl = 1690,                          /* -mmusl */
  OPT_mnan_ = 1691,                          /* -mnan= */
  OPT_mno_data_in_code = 1692,               /* -mno-data-in-code */
  OPT_mno_float = 1693,                      /* -mno-float */
  OPT_mno_flush_func = 1694,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1695,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1696,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1697,                     /* -mno-mips3d */
  OPT_modd_spreg = 1698,                     /* -modd-spreg */
  OPT_mpaired_single = 1699,                 /* -mpaired-single */
  OPT_mplt = 1700,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1701,           /* -mr10k-cache-barrier= */
  OPT_mradiax = 1702,                        /* -mradiax */
  OPT_mrelax_pic_calls = 1703,               /* -mrelax-pic-calls */
  OPT_msave_restore_mmd = 1704,              /* -msave-restore-mmd */
  OPT_mshared = 1705,                        /* -mshared */
  OPT_msimd = 1706,                          /* -msimd */
  OPT_msingle_float = 1707,                  /* -msingle-float */
  OPT_msmartmips = 1708,                     /* -msmartmips */
  OPT_msoft_float = 1709,                    /* -msoft-float */
  OPT_msplit_addresses = 1710,               /* -msplit-addresses */
  OPT_msym32 = 1711,                         /* -msym32 */
  OPT_msynci = 1712,                         /* -msynci */
  OPT_mtune_ = 1713,                         /* -mtune= */
  OPT_muclibc = 1714,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1715,        /* -muninit-const-in-rodata */
  OPT_munsafe_zero_overhead = 1716,          /* -munsafe-zero-overhead */
  OPT_mvirt = 1717,                          /* -mvirt */
  OPT_mvr4130_align = 1718,                  /* -mvr4130-align */
  OPT_mxgot = 1719,                          /* -mxgot */
  OPT_mxpa = 1720,                           /* -mxpa */
  OPT_mzero_overhead = 1721,                 /* -mzero-overhead */
  OPT_n = 1722,                              /* -n */
  ...
  OPT_symbol_ = 1839,                        /* -symbol= */
  OPT_symbolic = 1840,                       /* -symbolic */
  OPT_t = 1841,                              /* -t */
  OPT_time = 1842,                           /* -time */
  OPT_time_ = 1843,                          /* -time= */
  OPT_tno_android_cc = 1844,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1845,                 /* -tno-android-ld */
